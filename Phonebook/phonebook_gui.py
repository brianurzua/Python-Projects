...
# These are our own modules being imported
import phonebook_main
import phonebook_func


def load_gui(self):
	# Created a label, and painted it underneath
	...
	# Created buttons, and painted them.
